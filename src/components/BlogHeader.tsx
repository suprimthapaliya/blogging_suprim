    ...
    <header className="relative py-8 px-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-4xl font-bold text-gray-800">Nature Blog</h1>
        ...
        <div className="flex justify-center">
          <div className="relative w-full max-w-md">
            <input
              ...
              className="w-full px-4 py-3 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white/90"
            />
          </div>
        </div>
      </div>
